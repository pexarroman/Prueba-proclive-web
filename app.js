...
(function () {
  ...
  (function applyMeta() {
    ...
    // Solo la home toma título/descripción de config.js.
    // videos.html y profesionales.html llevan los suyos fijos en su <head>.
    if (!document.body.hasAttribute('data-own-meta')) {
      var t = get(CFG, 'meta.title'), d = get(CFG, 'meta.description');
  ...
  (function applyHero() {
    ...
    setImage('hero-image', 'hero-image-placeholder', get(CFG, 'images.hero'), get(CFG, 'legal.tradeName', '') + ' — clínica en Valdebebas');
  })();
  ...
  (function applyLegalModals() {
    ...
    setHTML('modal-aviso-legal-body',
      ...
      '</ul>' +
      '<p><strong>Objeto.</strong> El presente sitio web tiene como finalidad informar sobre los servicios de fisioterapia y actividad física ofrecidos por ' + esc(L.tradeName) + ' y facilitar el contacto y la solicitud de citas por parte de los usuarios.</p>' +
    ...
    setHTML('modal-privacidad-body',
      ...
      '<p><strong>Finalidad del tratamiento.</strong> Los datos personales facilitados a través de la plataforma de citas, WhatsApp, correo electrónico o llamada telefónica se tratan con la finalidad de gestionar solicitudes de información, reservas de cita y la relación con el paciente. Los datos de salud, en su caso, se tratan exclusivamente con fines de valoración y tratamiento fisioterapéutico.</p>' +
  ...
  (function initCookies() {
    ...
    if (!banner) return;
    var KEY = 'prolive_cookie_consent';
